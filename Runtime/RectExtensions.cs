...
namespace IKhom.ExtensionsLibrary.Runtime
{
    public static class RectExtensions
    {
        ...
        /// </summary>
        /// <param name="rect">The original Rect.</param>
        /// <param name="index">The index for the sub rect. Includes 0, and excludes count.</param>
        /// <param name="count">The amount of sub rects the Rect should be split into.</param>
